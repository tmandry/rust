...
fn compute_storage_conflicts(
    ...
    debug!("compute_storage_conflicts({:?})", mir.span);
    ...
    for_each_location(mir, &storage_live_analysis, &storage_live, |state, loc| {
        ...
        FxHashMap<BasicBlock, liveness::LiveVarSet>)
{
    ...
    // Gather live locals and their indices replacing values in mir.local_decls
